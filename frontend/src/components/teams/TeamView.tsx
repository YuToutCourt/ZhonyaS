...
const PositionIcon = ({ position, isSub = false }: { position: string, isSub?: boolean }) => {
  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <span className={`text-sm font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
        }`}>
...
export function TeamView({ teamId }: TeamViewProps) {
  ...
  useEffect(() => {
    ...
    const handleProgress = (data: any) => {
      ...
      console.log('Download progress:', { playerKey, ...data, calculatedProgress })
      ...
      setDownloadProgress(prev => ({
        ...
        [playerKey]: {
          ...
          status: calculatedProgress >= 100 ? 'completed' : 'downloading',
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <div className="flex items-center gap-4">
            <h1 className={`text-3xl font-bold transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-slate-900'
              }`}>
              {team.team_name}
            </h1>
            ...
            {team?.players && team.players.length > 0 && (
              <div className="flex gap-2">
                <a
                  ...
                  className={`flex items-center gap-1 px-2 py-1 rounded-md transition-all duration-300 hover:scale-105 ${theme === 'dark'
                ...
                >
                  <Image
                    ...
                    className="rounded"
                  />
                  <span className={`text-xs font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
                    }`}>
                    U.GG
                  </span>
                </a>
          ...
          <p className={`text-lg transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'
            }`}>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-2">
            <label className={`text-sm font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
              }`}>
              Time Period
            </label>
            <div className="flex gap-2">
              <Button
                ...
                className={`flex-1 transition-colors duration-300 ${downloadFilterType === 'all'
                  ? theme === 'dark'
              ...
              <Button
                ...
                className={`flex-1 transition-colors duration-300 ${downloadFilterType === 'season'
                  ? theme === 'dark'
                    ? 'bg-blue-600 hover:bg-blue-700'
                    : 'bg-blue-600 hover:bg-blue-700'
                  : theme === 'dark'
              ...
              <Button
                ...
                className={`flex-1 transition-colors duration-300 ${downloadFilterType === 'custom'
                  ? theme === 'dark'
                    ? 'bg-blue-600 hover:bg-blue-700'
                    : 'bg-blue-600 hover:bg-blue-700'
                  : theme === 'dark'
            ...
            {downloadFilterType === 'season' && (
              <select
                ...
                className={`w-full px-3 py-2 rounded-md border transition-colors duration-300 ${theme === 'dark'
            ...
            {downloadFilterType === 'custom' && (
              <div className="flex gap-2">
                <div className="flex-1">
                  <label className={`text-xs mb-1 block transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-600'
                    }`}>
                    Start Date
                  </label>
                  <Input
          ...
          <div className="flex items-center space-x-2">
            <div className="flex-1">
              <label className={`text-sm font-medium mb-1 block transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
                }`}>
                Games per Player
              </label>
              <input
                ...
                min="1"
                max="50"
                className={`w-full px-3 py-2 rounded border transition-colors duration-300 ${theme === 'dark'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className={`transition-colors duration-300 ${theme === 'dark'
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className={`text-sm font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'
              }`}>
              Total Games
            </CardTitle>
            <Users className={`h-4 w-4 transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
              }`} />
          </CardHeader>
          <CardContent>
            <div className={`text-2xl font-bold transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-slate-900'
              }`}>
        ...
        <Card className={`transition-colors duration-300 ${theme === 'dark'
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Trophy className={`h-4 w-4 transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
              }`} />
          </CardHeader>
          <CardContent>
            <div className={`text-2xl font-bold transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-slate-900'
        ...
        <Card className={`transition-colors duration-300 ${theme === 'dark'
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Target className={`h-4 w-4 transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
              }`} />
          </CardHeader>
          <CardContent>
      ...
      <Card className={`transition-colors duration-300 ${theme === 'dark'
        ...
        <CardHeader>
          <CardTitle className={`transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-slate-900'
            }`}>
            Joueurs de l'équipe
          </CardTitle>
          <CardDescription className={`transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
            }`}>
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow className={`transition-colors duration-300 ${theme === 'dark'
                ? 'border-slate-700 hover:bg-slate-800/50'
                : 'border-slate-200 hover:bg-slate-50'
                }`}>
                <TableHead className={`transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'
                  }`}>
                  Position
                </TableHead>
                <TableHead className={`transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'
              ...
              {team.players?.sort((a, b) => {
                ...
                >
                  ...
                  <TableCell>
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <span className={`font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-white' : 'text-slate-900'
                          }`}>
                      ...
                      {(() => {
                        const playerKey = `${player.player_name}#${player.player_tag}`
                        const progress = downloadProgress[playerKey]
                          ...
                          return (
                            <div className="space-y-1">
                              <Progress
                                ...
                                className={`h-1.5 ${progress.status === 'error' ? 'bg-red-200 dark:bg-red-900/20' : ''}`}
                              />
                              <div className="flex items-center justify-between text-xs">
                                <span className={`transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}>
                                  {progress.status === 'error'
                                    ? `Erreur: ${progress.error || 'Échec'}`
                                    : progress.status === 'downloading'
                                      ? `${progress.current} / ${progress.total} games`
                                      : 'En attente...'}
                                </span>
                                <span className={`font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'}`}>
                  ...
                  <TableCell>
                    {player.player_stats?.ranked_solo ? (
                      <RankDisplay rank={player.player_stats.ranked_solo} />
                    ) : (
                      <span className={`text-sm transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-400'
                        }`}>
                        N/A
                      </span>
                    )}
                  ...
                  <TableCell>
                    {player.player_stats?.ranked_flex ? (
                      <RankDisplay rank={player.player_stats.ranked_flex} />
                    ) : (
                      <span className={`text-sm transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-400'
                        }`}>
                        N/A
                  ...
                  <TableCell>
                    {player.player_stats ? (
                      <div className="space-y-1">
                        <div className={`text-sm transition-colors duration-300 ${theme === 'dark' ? 'text-slate-300' : 'text-slate-600'
                          }`}>
                          {player.player_stats.total_games} games • {Number(player.player_stats.winrate).toFixed(1)}% WR
                        </div>
                        <div className={`text-sm transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
                          }`}>
                          KDA: {Number(player.player_stats.kda).toFixed(2)}
                        </div>
                      </div>
                    ) : (
                      <span className={`text-sm transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
                        }`}>
                        Aucune donnée
                      </span>
                    )}
                        ...
                        {player.top_champions.slice(0, 3).map((champion, index) => (
                          <div key={index} className={`flex items-center space-x-2`}>
                            ...
                            <div className="flex flex-col">
                              <span className={`text-sm font-medium transition-colors duration-300 ${theme === 'dark' ? 'text-slate-200' : 'text-slate-700'
                                }`}>
                                {champion.champion_name}
                              </span>
                              <span className={`text-xs transition-colors duration-300 ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'
                                }`}>
